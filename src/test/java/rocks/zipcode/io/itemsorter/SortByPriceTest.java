...
public class SortByPriceTest {
    ...
    public void test2() {
        // given
        Item item3 = new Item(0L, "Apple", 9.0);
        Item item2 = new Item(1L, "Banana", 4.5);
        Item item1 = new Item(2L, "Cherry", 6.0);
        Item[] itemsToSort = {item2, item1, item3};
    ...
    public void test3() {
        // given
        Item item3 = new Item(0L, "Apple", 12.2);
        Item item2 = new Item(1L, "Banana", 5.6);
        Item item1 = new Item(2L, "Cherry", 1.2);
